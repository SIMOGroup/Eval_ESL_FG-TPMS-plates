function [nat_coord] = cal_nat_coord_surf(NURBS,ni,nj,nodes,c_point)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate natural coordinate (xi, eta) of a physical point on a NURBS surface %%%
...
while (err > eps)
    ...
    [N, dNdxi, ~, ~, ~, ~] = cal_Kine_Shape_2D_2nd(NURBS,ni,nj,nat_coord(1),nat_coord(2));
