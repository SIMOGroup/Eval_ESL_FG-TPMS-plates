function [point_disp] = cal_point_displacement_2D_RPT(IGA,Plate,phys_coord)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate displacement field of specific point of rectangular plate with 4-Dof 2D RPT plate models %%%
...
h_u = [1, phys_coord(3), fz-phys_coord(3)];
