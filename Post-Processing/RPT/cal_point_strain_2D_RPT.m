function [point_strain] = cal_point_strain_2D_RPT(IGA,Plate,phys_coord)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate strain field of specific point of rectangular plate with 4-Dof 2D RPT plate models %%%
