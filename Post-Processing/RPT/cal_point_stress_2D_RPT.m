function [point_stress] = cal_point_stress_2D_RPT(IGA,Plate,phys_coord)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate stress field of specific point of rectangular plate with 4-Dof 2D RPT plate models %%%
...
h_e = [1, phys_coord(3), fz-phys_coord(3)];
...
stress_s = dfz*Q.Qs*Bs*U(sctrF,1);
