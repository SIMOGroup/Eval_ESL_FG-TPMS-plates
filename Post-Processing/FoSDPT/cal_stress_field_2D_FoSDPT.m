function [FE_stress] = cal_stress_field_2D_FoSDPT(IGA,Plate,z_coords)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate stress field on FE grid of rectangular plate with 7-Dof 2D SS's FoSDPT plate models %%%
