function [output] = cal_plot_strain_2D_FoSDPT(IGA, Plate, plot_type, varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate and plot strain field of rectangular plate with 7-Dof 2D SS's FoSDPT plate models %%%
...
if point_plot
    point_strain = cal_point_strain_2D_FoSDPT(IGA,Plate,point_coord);
...
if point_dist_plot
    ...
    point_strain_dist = cal_point_strain_distribution_2D_FoSDPT(IGA,Plate,point_coord,FE_strain_curve.z_coords);
...
if FE_surf_plot
    ...
    FE_strain = cal_strain_field_2D_FoSDPT(IGA,Plate,FE_strain_surf.z_coords);
...
if FE_vol_plot
    ...
    FE_strain = cal_strain_field_2D_FoSDPT(IGA,Plate,FE_strain_vol.z_coords);
    FE_strain_norm = compute_strain_normalization(FE_strain,norm_method,Plate);
