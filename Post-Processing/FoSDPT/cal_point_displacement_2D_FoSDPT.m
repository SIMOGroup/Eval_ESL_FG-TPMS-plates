function [point_disp] = cal_point_displacement_2D_FoSDPT(IGA,Plate,phys_coord)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate displacement field of specific point of rectangular plate with 7-Dof 2D SS's FoSDPT plate models %%%
...
h_u = [1, 4/3*(phys_coord(3)^3)/h^2, phys_coord(3) - 4/3*(phys_coord(3)^3)/h^2, phys_coord(3)^2 + 2*(phys_coord(3)^4)/h^2];
