function [point_strain] = cal_point_strain_2D_FoSDPT(IGA,Plate,phys_coord)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate strain field of specific point of rectangular plate with 7-Dof 2D SS's FoSDPT plate models %%%
