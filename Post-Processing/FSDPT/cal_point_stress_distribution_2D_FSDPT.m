function [point_stress_dist] = cal_point_stress_distribution_2D_FSDPT(IGA,Plate,phys_coord,z_coords)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate stress distribution field of specific point of rectangular plate with 5-Dof 2D RM's FSDPT plate models %%%
...
for i_z = 1:npoint_z
    ...
    stress_s = k_scf*Q.Qs*Bs*U(sctrF,1);
