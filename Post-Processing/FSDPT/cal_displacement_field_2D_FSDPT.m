function [FE_disp] = cal_displacement_field_2D_FSDPT(IGA,Plate,z_coords)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate displacement field on FE grid of rectangular plate with 5-Dof 2D RM's FSDPT plate models %%%
...
for j = 1:npoint_y
    ...
    for i = 1:npoint_x
        ...
        [N, ~, ~, ~, ~, ~] = cal_Kine_Shape_2D_2nd(IGA.NURBS,ni,nj,u,v);
