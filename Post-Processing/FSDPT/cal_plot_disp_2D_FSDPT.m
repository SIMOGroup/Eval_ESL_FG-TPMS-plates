function [output] = cal_plot_disp_2D_FSDPT(IGA, Plate, plot_type, varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate and plot displacement field of rectangular plate with 5-Dof 2D RM's FSDPT plate models %%%
...
if point_plot
    point_disp = cal_point_displacement_2D_FSDPT(IGA,Plate,point_coord);
...
if point_dist_plot
    ...
    point_disp_dist = cal_point_displacement_distribution_2D_FSDPT(IGA,Plate,point_coord,FE_disp_curve.z_coords);
...
if FE_surf_plot
    ...
    FE_disp = cal_displacement_field_2D_FSDPT(IGA,Plate,FE_disp_surf.z_coords);
...
if FE_vol_plot
    ...
    FE_disp = cal_displacement_field_2D_FSDPT(IGA,Plate,FE_disp_vol.z_coords);
    FE_disp_norm = compute_displacement_normalization(FE_disp,norm_method,Plate);
