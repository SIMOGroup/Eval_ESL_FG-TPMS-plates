function [point_disp_dist] = cal_point_displacement_distribution_2D_FSDPT(IGA,Plate,phys_coord,z_coords)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate displacement distribution field of specific point of rectangular plate with 5-Dof 2D RM's FSDPT plate models %%%
...
[N, ~, ~, ~, ~, ~] = cal_Kine_Shape_2D_2nd(IGA.NURBS,ni,nj,nat_coord(1),nat_coord(2));
