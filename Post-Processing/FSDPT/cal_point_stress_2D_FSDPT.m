function [point_stress] = cal_point_stress_2D_FSDPT(IGA,Plate,phys_coord)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate stress field of specific point of rectangular plate with 5-Dof 2D RM's FSDPT plate models %%%
