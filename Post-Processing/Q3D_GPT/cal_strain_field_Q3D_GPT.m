function [FE_strain] = cal_strain_field_Q3D_GPT(IGA,Plate,z_coords)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate strain field on FE grid of rectangular plate with 6-Dof Quasi-3D GPT plate models %%%
...
for j = 1:npoint_y
    ...
    for i = 1:npoint_x
        ...
        for i_z = 1:npoint_z
            ...
            FE_strain(i,j,i_z,:) = [strain_b; strain_s; strain_st];
        end
    end
end
end
