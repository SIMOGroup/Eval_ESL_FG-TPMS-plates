function [point_stress_dist] = cal_point_stress_distribution_Q3D_GPT(IGA,Plate,phys_coord,z_coords)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate stress distribution field of specific point of rectangular plate with 6-Dof Quasi-3D GPT plate models %%%
...
point_stress_dist = zeros(npoint_z, 6);
...
for i_z = 1:npoint_z
    ...
    point_stress_dist(i_z,:) = [stress_b; stress_s; stress_st];
end
end
