function [point_strain_dist] = cal_point_strain_distribution_Q3D_GPT(IGA,Plate,phys_coord,z_coords)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate strain distribution field of specific point of rectangular plate with 6-Dof Quasi-3D GPT plate models %%%
...
for i_z = 1:npoint_z
    ...
    point_strain_dist(i_z,:) = [strain_b; strain_s; strain_st];
end
end
