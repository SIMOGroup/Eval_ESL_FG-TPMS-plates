function [output] = cal_plot_strain_Q3D_GPT(IGA, Plate, plot_type, varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate and plot strain field of rectangular plate with 6-Dof Quasi-3D GPT plate models %%%
...
switch plot_type
    ...
    case 'FE_vol'
        ...
        feature_idx = find(strain_vector == varargin{1});
    otherwise
        error('Unknown keyword: %s', plot_type);cal_point_strain_Q3D_GPT(IGA,Plate,point_coord);
end
%% ====== Calculation and plot ======
% --- Strain at a specific point in 3D ---
if point_plot
    point_strain = cal_point_strain_Q3D_GPT(IGA,Plate,point_coord);
...
if point_dist_plot
    ...
    point_strain_dist = cal_point_strain_distribution_Q3D_GPT(IGA,Plate,point_coord,FE_strain_curve.z_coords);
...
if FE_surf_plot
    ...
    FE_strain = cal_strain_field_Q3D_GPT(IGA,Plate,FE_strain_surf.z_coords);
...
if FE_vol_plot
    ...
    FE_strain = cal_strain_field_Q3D_GPT(IGA,Plate,FE_strain_vol.z_coords);
    FE_strain_norm = compute_strain_normalization(FE_strain,norm_method,Plate);
