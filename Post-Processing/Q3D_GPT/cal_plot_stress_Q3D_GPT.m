function [output] = cal_plot_stress_Q3D_GPT(IGA, Plate, plot_type, varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate and plot stress field of rectangular plate with 6-Dof Quasi-3D GPT plate models %%%
...
if point_plot
    point_stress = cal_point_stress_Q3D_GPT(IGA,Plate,point_coord);
...
if point_dist_plot
    ...
    point_stress_dist = cal_point_stress_distribution_Q3D_GPT(IGA,Plate,point_coord,FE_stress_curve.z_coords);
...
if FE_surf_plot
    ...
    FE_stress = cal_stress_field_Q3D_GPT(IGA,Plate,FE_stress_surf.z_coords);
...
if FE_vol_plot
    ...
    FE_stress = cal_stress_field_Q3D_GPT(IGA,Plate,FE_stress_vol.z_coords);
    FE_stress_norm = compute_stress_normalization(FE_stress,norm_method,Plate);
