function [NURBS_defl] = cal_deflection_Q3D_GPT(IGA,Plate)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate deflection (transverse displacement) of all control points of rectangular plate with 6-Dof Quasi-3D GPT plate models %%%
