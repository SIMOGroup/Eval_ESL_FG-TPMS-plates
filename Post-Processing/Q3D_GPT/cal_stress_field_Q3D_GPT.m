function [FE_stress] = cal_stress_field_Q3D_GPT(IGA,Plate,z_coords)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate stress field on FE grid of rectangular plate with 6-Dof Quasi-3D GPT plate models %%%
