function [point_strain] = cal_point_strain_Q3D_GPT(IGA,Plate,phys_coord)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate strain field of specific point of rectangular plate with 6-Dof Quasi-3D GPT plate models %%%
...
point_strain = [strain_b; strain_s; strain_st];
