function [output] = cal_plot_defl_2D_GPT(IGA, Plate, plot_type, varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate and plot deflection (transverse displacement) of rectangular plate with 5-Dof 2D GPT plate models %%%
...
if cen_defl
    cen_point_disp = cal_point_displacement_2D_GPT(IGA,Plate,[L/2,W/2,0]);
...
if NURBS_defl
    NURBS_defl = cal_deflection_2D_GPT(IGA,Plate);
