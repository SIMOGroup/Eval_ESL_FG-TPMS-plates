function [point_disp_dist] = cal_point_displacement_distribution_2D_TSDPT(IGA,Plate,phys_coord,z_coords)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate displacement distribution field of specific point of rectangular plate with 5-Dof 2D Reddy's TSDPT plate models %%%
...
for i_z = 1:npoint_z
    ...
    h_u = [1, 4/3*(z^3)/h^2, z - 4/3*(z^3)/h^2];
