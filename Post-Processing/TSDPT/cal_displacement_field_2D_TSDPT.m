function [FE_disp] = cal_displacement_field_2D_TSDPT(IGA,Plate,z_coords)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate displacement field on FE grid of rectangular plate with 5-Dof 2D Reddy's TSDPT plate models %%%
