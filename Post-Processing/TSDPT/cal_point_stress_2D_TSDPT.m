function [point_stress] = cal_point_stress_2D_TSDPT(IGA,Plate,phys_coord)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate stress field of specific point of rectangular plate with 5-Dof 2D Reddy's TSDPT plate models %%%
...
h_e = [1, 4/3*(phys_coord(3)^3)/h^2, phys_coord(3) - 4/3*(phys_coord(3)^3)/h^2];
...
stress_s = (1 - 4*(phys_coord(3)^2)/h^2)*Q.Qs*Bs*U(sctrF,1);
