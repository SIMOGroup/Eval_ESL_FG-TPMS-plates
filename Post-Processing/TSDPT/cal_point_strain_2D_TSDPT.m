function [point_strain] = cal_point_strain_2D_TSDPT(IGA,Plate,phys_coord)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate strain field of specific point of rectangular plate with 5-Dof 2D Reddy's TSDPT plate models %%%
...
strain_s = (1 - 4*(phys_coord(3)^2)/h^2)*Bs*U(sctrF,1);
