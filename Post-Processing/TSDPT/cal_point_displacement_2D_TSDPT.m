function [point_disp] = cal_point_displacement_2D_TSDPT(IGA,Plate,phys_coord)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate displacement field of specific point of rectangular plate with 5-Dof 2D Reddy's TSDPT plate models %%%
...
h_u = [1, 4/3*(phys_coord(3)^3)/h^2, phys_coord(3) - 4/3*(phys_coord(3)^3)/h^2];
