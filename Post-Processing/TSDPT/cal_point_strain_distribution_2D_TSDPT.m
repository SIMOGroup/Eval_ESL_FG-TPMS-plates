function [point_strain_dist] = cal_point_strain_distribution_2D_TSDPT(IGA,Plate,phys_coord,z_coords)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate strain distribution field of specific point of rectangular plate with 5-Dof 2D Reddy's TSDPT plate models %%%
...
for i_z = 1:npoint_z
    ...
    strain_s = (1 - 4*(z^2)/h^2)*Bs*U(sctrF,1);
