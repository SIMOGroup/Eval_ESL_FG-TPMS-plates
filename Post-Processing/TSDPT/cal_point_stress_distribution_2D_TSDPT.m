function [point_stress_dist] = cal_point_stress_distribution_2D_TSDPT(IGA,Plate,phys_coord,z_coords)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate stress distribution field of specific point of rectangular plate with 5-Dof 2D Reddy's TSDPT plate models %%%
