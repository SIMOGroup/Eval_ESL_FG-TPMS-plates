function [point_strain_dist] = cal_point_strain_distribution_2D_CPT(IGA,Plate,phys_coord,z_coords)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate strain distribution field of specific point of rectangular plate with 3-Dof 2D CPT plate models %%%
