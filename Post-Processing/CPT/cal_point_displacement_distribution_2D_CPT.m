function [point_disp_dist] = cal_point_displacement_distribution_2D_CPT(IGA,Plate,phys_coord,z_coords)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate displacement distribution field of specific point of rectangular plate with 3-Dof 2D CPT plate models %%%
