function [point_stress_dist] = cal_point_stress_distribution_Q3D_RPT(IGA,Plate,phys_coord,z_coords)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate stress distribution field of specific point of rectangular plate with 4-Dof Quasi-3D RPT plate models %%%
