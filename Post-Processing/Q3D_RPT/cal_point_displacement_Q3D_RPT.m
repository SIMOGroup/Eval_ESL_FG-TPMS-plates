function [point_disp] = cal_point_displacement_Q3D_RPT(IGA,Plate,phys_coord)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate displacement field of specific point of rectangular plate with 4-Dof Quasi-3D RPT plate models %%%
...
[gz, ~] = compute_iterated_stretching_deformation_function(phys_coord(3),h,shear_func,stretch_func,n_iterated);

h_u = [1, phys_coord(3), fz, gz];
