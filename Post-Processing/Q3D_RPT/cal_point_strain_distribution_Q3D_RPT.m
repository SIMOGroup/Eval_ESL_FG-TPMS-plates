function [point_strain_dist] = cal_point_strain_distribution_Q3D_RPT(IGA,Plate,phys_coord,z_coords)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate strain distribution field of specific point of rectangular plate with 4-Dof Quasi-3D RPT plate models %%%
