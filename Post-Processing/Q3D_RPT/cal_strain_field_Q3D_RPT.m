function [FE_strain] = cal_strain_field_Q3D_RPT(IGA,Plate,z_coords)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate strain field on FE grid of rectangular plate with 4-Dof Quasi-3D RPT plate models %%%
