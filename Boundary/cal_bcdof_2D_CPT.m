function [bcdof, bcval] = cal_bcdof_2D_CPT(IGA,Plate)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate dofs of boundary conditions with 3-Dof 2D CPT plate models %%%
...
%% ===== Dofs of control points on boundaries (dofs = u_{0}, v_{0}, w_{0}) =====
for i_bc = 1:length(bc_case)
    switch bc_case(i_bc)
        case 1  % Clamped (C)
            for idof = [1, 2, 3]  % Constraint u_{0}, v_{0}, w_{0} at perimeter
