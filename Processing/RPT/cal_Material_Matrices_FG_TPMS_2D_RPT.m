function [D] = cal_Material_Matrices_FG_TPMS_2D_RPT(Plate)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate material matrices for FG-TPMS for 4-Dof 2D RPT plate models %%%
...
for iGauss = 1:size(Wg,1)  % Loop over the integration points
    ...
    % --- Shear deformation function (First variant: df(+-h/2)/dz = 0) ---
