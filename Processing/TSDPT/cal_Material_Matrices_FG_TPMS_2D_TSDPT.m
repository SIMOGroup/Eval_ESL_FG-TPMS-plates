function [D] = cal_Material_Matrices_FG_TPMS_2D_TSDPT(Plate)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Calculate material matrices for FG-TPMS for 5-Dof 2D Reddy's TSDPT plate models %%%
...
for iGauss = 1:size(Wg,1)  % Loop over the integration points
    ...
    h_e = [1, 4/3*(gpt^3)/h^2, gpt - 4/3*(gpt^3)/h^2];
    for i = 1:3
        for j = 1:3
    ...
    D.Ds = D.Ds + (1 - 4*(gpt^2)/h^2)^(2)*Qs*gwt;
end
end
